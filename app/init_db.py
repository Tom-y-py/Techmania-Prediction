"""
Script to initialize database and load historical data from CSV
"""
import pandas as pd
import sys
...
from database import init_db, SessionLocal, HistoricalData


def load_csv_to_db(csv_path: str = "../data/processed/techmania_with_weather_and_holidays.csv"):
    ...
    print(f"CSV contains {len(df.columns)} columns:")
    ...
    try:
        ...
        # Final commit
        db.commit()
        print(f"\n✓ Successfully loaded {records_added} records into database!")
